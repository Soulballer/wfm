...
function streamPolygon(coordinates, stream) {
  ...
  console.log('coord', coordinates, stream)
  stream.polygonStart();
...
function geoStream(object, stream) {
  if (object && streamObjectType.hasOwnProperty(object.type)) {
    ...
    console.log('streamgeom', streamObjectType[object.type](object, stream))
  } else {
...
function index$1(projection, context) {
  ...
  function path(object) {
    console.log('object inside path', object)
    if (object) {
      if (typeof pointRadius === "function") {console.log('func'); contextStream.pointRadius(+pointRadius.apply(this, arguments));}
      geoStream(object, projectionStream(contextStream));
      console.log('object inside');
    }
    console.log('ll', projectionStream(contextStream));
